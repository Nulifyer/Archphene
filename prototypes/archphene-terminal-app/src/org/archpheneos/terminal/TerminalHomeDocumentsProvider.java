...
public final class TerminalHomeDocumentsProvider extends DocumentsProvider {
    private static final String ROOT_ID = "archphene-terminal-home";
    ...
    @Override public Cursor queryRoots(String[] projection) {
        ...
        rows.newRow()
                ...
                .add(DocumentsContract.Root.COLUMN_SUMMARY, "Terminal and Linux files")
    ...
    private File root() {
        File root = new File(getContext().getFilesDir(), "terminal/home");
        root.mkdirs();
        return root;
    }
