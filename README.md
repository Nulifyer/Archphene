...
- Foot's primary application and Bash closure pass on x86_64 and AArch64, but generic auxiliary-command materialization still needs work: its packaged `clear` helper currently cannot resolve `libc.so.6` in the helper loader namespace.
