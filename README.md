...
2. Complete the remaining Android capability brokers for camera, drag-and-drop, accessibility, and secrets/keyrings. Manager-owned GUI homes, active-app document activation, private XDG URL/notification/printing adapters, and Pulse-to-AAudio input/output are implemented.
