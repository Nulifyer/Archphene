...
2. Broaden the validated AT-SPI2 and Secret Service integrations beyond current Qt/GTK, libsecret, and KWallet clients while retaining x86_64 and physical AArch64 regressions. Streaming XDG Camera/PipeWire, bounded Camera2 JPEG, Android virtual accessibility, Android Keystore-backed secrets, manager-owned GUI homes, active-app document activation, brokered drag-and-drop, private XDG URL/notification/printing adapters, and Pulse-to-AAudio output are implemented; microphone input remains.
