...
archphene_require_file "$ARCHPHENE_ROOT/tooling/build/android-pulse/$architecture/out/SHA256SUMS"
archphene_note "Android Pulse runtime built for $architecture."
