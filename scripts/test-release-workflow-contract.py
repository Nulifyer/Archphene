...
required_workflow = (
    ...
    "--verify-binaries",
    "Archphene-termux-pulse-source-$version_name.zip",
    ...
    "Archphene-native-licenses-$version_name.zip",
    ...
    '$name.rust-licenses.zip.sha256',
    '--source-revision "$SOURCE_REVISION"',
    '$name.spdx.json.sha256',
