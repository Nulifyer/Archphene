...
def main() -> None:
    ...
    lifecycle_tokens = (
        ...
        (translator_source,
         ...
         "parent-first showing snapshots"),
        (translator_source,
    ...
    fallback_tokens = (
        ...
        (android_activity_source, "session.touchClick(", "touch menu activation"),
        (android_activity_source, "session.pointerClick(", "pointer menu activation"),
        (android_activity_source, 'if ("qt6".equals(toolkit))',
         "toolkit menu activation policy"),
