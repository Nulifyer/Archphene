...
def main() -> None:
    ...
    lifecycle_tokens = (
        ...
        (translator_source, "for (int window_roots = 1; window_roots >= 0; window_roots--)",
         "window-first transient snapshots"),
        ...
        (translator_source, "remove_captured_showing_roots_locked(",
         "action-scoped showing-root cleanup"),
        ...
        (translator_source,
         "if (build_result < 0) {",
         "failed-tree snapshot retention"),
        (translator_source,
