...
def main() -> None:
    ...
    lifecycle_tokens = (
        ...
        (translator_source, "bool compositor_menu_click = menu_bar_click || node.menu_item;",
         "compositor menu-item activation"),
        (translator_source, "activate_menu_pointer(id, menu_bar_click)",
