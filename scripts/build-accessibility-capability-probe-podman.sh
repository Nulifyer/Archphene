...
podman run --rm -v "$ARCHPHENE_ROOT:/workspace" -w /workspace \
  ...
  "$image" bash scripts/build-accessibility-capability-probe.sh
apk="$ARCHPHENE_ROOT/prototypes/accessibility-capability-probe/out-$android_abi/archphene-accessibility-probe.apk"
archphene_require_file "$apk"
archphene_note "Container-built accessibility capability probe: $apk"
