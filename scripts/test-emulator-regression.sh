...
tests=(test-linux-manager-update test-linux-manager-pull-refresh test-linux-manager-kcalc test-runtime-module-fd-sharing test-linux-manager-catalog test-linux-manager-obtainium-workflow test-linux-manager-repository-search test-linux-manager-version-selector test-kcalc-menu-switch native-compositor test-kcalc-calculation test-kcalc-live-resize test-kcalc-live-theme)
