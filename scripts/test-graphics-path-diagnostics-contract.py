...
require(
    ...
    "MAX_PENDING_RELEASES: usize = 3",
    "RELEASE_PACKET_MARKER: u8 = 0x52",
    "flush_releases",
    "sends_bounded_release_frames_before_optional_fences",
...
require(
    ...
    "window_allows_direct_gpu_present",
    "direct_gpu_surface_is_opaque_full_output",
    "committed_opaque_region.as_ref()",
