...
- Project trees currently use explicit synchronized mirrors; a live SAF path broker and manager-owned GUI document integration remain pending. Optional shells beyond managed Bash have not been selected.
