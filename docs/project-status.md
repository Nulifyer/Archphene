...
- Persisted project-tree mappings and an Arch user shell, as described in [Terminal applications](terminal-apps.md). The foreground-service-owned tab/session lifecycle and correlated manager command channel are validated on 4 KB and 16 KB x86_64 emulators and physical AArch64.
