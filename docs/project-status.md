...
1. **Shared native compositor**
   - move the validated focused, demand-driven native clipboard descriptor broker from the probe into the shared Activity service with listener feedback suppression, then add Android IME/text input;
