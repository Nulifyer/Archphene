...
- Deliver new document intents to an already-running wrapper through a generic activation or safe restart policy.
- Complete capability-to-Android-permission brokers beyond documents and persisted project trees.
