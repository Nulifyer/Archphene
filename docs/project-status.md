...
1. **Shared native compositor**
   - continue after the validated registry, SHM, surface, initial xdg-toplevel, map/unmap, xdg_positioner, initial popup role/configure/destruction/idempotent dismissal, pointer, XKB keymap, focus, hardware-key, and live output mode/scale slices with popup grabs/reposition/composition, clipboard, and Android IME/text input;
