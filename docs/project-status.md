...
1. **Shared native compositor**
   - move the validated clipboard descriptor broker and text-input v3 lifecycle from the probe into the shared Activity service, add ClipboardManager feedback suppression, and connect a real Android InputConnection for arbitrary UTF-8/preedit/delete/editor actions;
