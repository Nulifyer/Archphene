...
1. **Shared native compositor**
   - connect the validated native wl_data_device text selection lifecycle to a focused, demand-driven Android ClipboardManager broker, then add Android IME/text input;
