...
1. **Shared native compositor**
   - continue after the validated registry, SHM, surface, initial xdg-toplevel, map/unmap, pointer, XKB keymap, focus, and hardware-key slices with popups, clipboard, Android IME/text input, and output state;
