...
1. **Shared native compositor**
   - continue after the validated registry, SHM, surface, and initial xdg-toplevel slices with configure queues, mapped/unmapped transitions, seats, popups, clipboard, text input, and output state;
