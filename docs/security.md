...
- One static runtime module now executes from a manager-owned, hash-verified, read-only descriptor under a separate wrapper UID. Complete dependency closures still use mutable app-private extraction and need atomic runtime packs plus durable brokered grants.
