...
| `gnome-text-editor` | GTK 4/libadwaita | Partial | Current-source x86_64 and manager-owned AArch64 wrappers pass SAF import/edit/writeback/cold reopen, DocumentsUI provider discovery, stable-process live light/dark and cold dark launch, and state-preserving Android accessibility for tabs, menus, Preferences, labels, enabled state, actions, bounds, and dismissed-dialog removal. Bidirectional clipboard selection and complex compose/non-Latin input remain. |
...
| GTK 4/libadwaita | `gnome-text-editor` | IME, adaptive layout, open/save, popups, accessibility, and lifecycle. | Partial: current-source x86_64 and manager-owned AArch64 pass SAF edit/writeback/cold reopen, provider browse, live/cold theme, and state-preserving semantic tab/menu/Preferences workflows. Bidirectional clipboard selection and complex composition remain. |
