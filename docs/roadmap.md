...
- broader clipboard MIME types beyond the validated demand-driven plain-text `wl-clipboard` path, legacy client-supplied cursor bitmap transfer, and remaining pointer protocol completeness;
