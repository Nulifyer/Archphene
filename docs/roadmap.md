...
- streaming XDG Camera/PipeWire, AT-SPI2 accessibility, packaged-client validation of the implemented Secret Service keyring, and remaining portal adapters; URL handling, notifications, printing, drag-and-drop, private Pulse-to-AAudio input/output, bounded Camera2 capture, Android accessibility semantics, and encrypted Android Keystore secret storage are implemented;
