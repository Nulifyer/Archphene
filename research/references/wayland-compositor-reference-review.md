...
- wl_registry discovery, wl_compositor and wl_shm global binds, SHM format events, SCM_RIGHTS pool-FD transfer, checked buffer creation and pixel reads, SHM resource destruction, and wl_surface create/destroy lifecycle on both the x86_64 emulator and AArch64 Samsung device.
