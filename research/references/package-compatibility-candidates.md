...
|---|---|---|
| `gnome-text-editor` | Partial: current-source x86_64 and manager-owned AArch64 wrappers pass generic SAF import/edit/writeback/cold reopen, DocumentsUI provider discovery, stable-process live light/dark and cold dark launch, and state-preserving Android accessibility for tabs, menus, Preferences, labels, actions, bounds, and dismissed-dialog removal. | Add focused bidirectional clipboard selection plus compose/dead-key, emoji, and non-Latin preedit/commit coverage. |
