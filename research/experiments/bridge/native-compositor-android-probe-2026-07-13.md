...
|---|---|---|
| x86_64 | Android 16 emulator, emulator-5554 | Passed clipped damage-batched frame/pixel presentation with Choreographer-timestamped deferred callbacks, inverse buffer transform/scale and no-reattach restoration, xdg configure/ack, committed parent window geometry, popup-focus preservation, system-injected Android tap/wheel/touch MotionEvent routing, exact pointer, v9 wheel-axis, cursor, viewporter/fractional-scale, and swipe/pinch/hold wire events, native text-selection lifecycle, bidirectional focused Android ClipboardManager pipe transfer, text-input v3 focus/state/event sequencing, and ordered teardown |
| arm64-v8a | Samsung Galaxy S22 Ultra, RFCT90AEEFA | Passed clipped damage-batched frame/pixel presentation with Choreographer-timestamped deferred callbacks, inverse buffer transform/scale and no-reattach restoration, xdg configure/ack, committed parent window geometry, popup-focus preservation, system-injected Android tap/wheel/touch MotionEvent routing, wrapped 32-bit timestamps, exact pointer, v9 wheel-axis, cursor, viewporter/fractional-scale, and swipe/pinch/hold wire events, native text-selection lifecycle, bidirectional focused Android ClipboardManager pipe transfer, text-input v3 focus/state/event sequencing, and ordered teardown |
