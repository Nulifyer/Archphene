...
26. Withdraw the Android offer on focus loss, close all queued descriptors, and decode any wl_display.error deterministically.
...
|---|---|---|
| x86_64 | Android 16 emulator, emulator-5554 | Passed frame/pixel presentation, xdg configure/ack, committed parent window geometry, popup-focus preservation, system-injected Android MotionEvent routing, exact pointer wire events, native text-selection lifecycle, bidirectional focused Android ClipboardManager pipe transfer, and ordered teardown |
| arm64-v8a | Samsung Galaxy S22 Ultra, RFCT90AEEFA | Passed frame/pixel presentation, xdg configure/ack, committed parent window geometry, popup-focus preservation, system-injected Android MotionEvent routing, wrapped 32-bit timestamps, exact pointer wire events, native text-selection lifecycle, bidirectional focused Android ClipboardManager pipe transfer, and ordered teardown |
