...
21. Bind wl_seat, require the Archphene name plus pointer/keyboard capabilities, and create a wl_pointer for the client owning the mapped xdg surface.
