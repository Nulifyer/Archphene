...
- [ ] Finish Qt and GTK appearance consistency.
  ...
  - [x] Replace the appearance cycle-buttons with described, accessible discrete sliders for geometry, text, and control density; make Compact the fresh-install control default while retaining display-aware Auto.
