...
- [ ] Complete Android capability and document brokers.
  ...
  - [ ] Complete camera, accessibility, and secrets/keyrings integration.
    ...
    - [ ] Validate packaged Arch libsecret and KWallet clients against the private Secret Service adapter before claiming broad unmodified-toolkit compatibility.
      ...
      - [ ] Build the patched AArch64 KWallet compatibility daemon and validate official `kwallet-query` on physical ARM; upstream Arch x86_64 clients remain unusable on 16 KB Android because their ELF files are 4 KB-aligned.
