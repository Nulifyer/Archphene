...
- [ ] Finish Qt and GTK appearance consistency.
  ...
  - [x] Add Automatic, Compact, Comfortable, and Touch control-density policy independently from geometry and text scaling; feed the selected minimum target into GTK metrics and the Qt style.
  ...
  - [ ] Pass KCalc and Mousepad in light/dark and Automatic/Compact/Comfortable/Touch modes across phone, tablet, and docked layouts; repeat current-source core cases on physical AArch64.
    ...
    - [ ] Repeat current-source core cases on physical AArch64. The connected Samsung's installed manager/wrappers use the earlier development signer; do not erase its manager key and 11 app sandboxes merely to replace that signer.
