...
- [ ] Perform a complete UX pass over discovery, package details, installation, launcher creation, updates, storage, permissions, setup, settings, and recovery.
  ...
  - [ ] Stop automatically resubmitting user-cancelled Android launcher installations after manager restart; retain explicit Retry/Dismiss choices and offer a reviewed batch-selection flow when one dependency introduces several desktop entries.
