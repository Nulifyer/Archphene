...
- [ ] Perform a complete UX pass over discovery, package details, installation, launcher creation, updates, storage, permissions, setup, settings, and recovery.
  ...
  - [ ] Replace the remaining dense single-screen scaffold with responsive Packages, Files, and Terminal navigation, clear hierarchy, compact phone layouts, and expanded tablet/external-display layouts.
