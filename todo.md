...
- [ ] Add capabilities in test-gated vertical slices; do not port code merely because it existed before.
  ...
  - [ ] Terminal/PTY and shared command environment
    ...
    - [ ] Replace the diagnostic command panel with production terminal rendering, scrollback, selection, IME, hardware keyboard, clipboard, and accessibility.
      ...
      - [x] Join consecutive soft-wrapped scrollback rows into bounded logical lines and reflow them at the current width without splitting wide graphemes. Width measurements are cached outside resize/line-extension work, warmed output remains allocation-free, and stable-process portrait-to-landscape gates pass on exact x86_64 and AArch64 devices with full-device screenshots.
      - [ ] Complete remaining xterm controls/modes, resize reflow across the live-screen/history boundary, selection handles/autoscroll and history-stable ranges, non-Latin/composing IME coverage, and richer accessibility before calling the surface production-ready.
